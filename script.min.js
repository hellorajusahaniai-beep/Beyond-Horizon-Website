(() => {
    ...
    class StageSequenceController {
        constructor() {
            ...
            this.zone2End = this.zone2Start + this.zone2Duration; 
            this.zone2Midpoint = this.zone2Start + (this.zone2Duration / 2); 
            this.zone3Start = this.zone2End; 
            this.zone3Duration = 3.60 * this.cachedVh;
            this.zone3End = this.zone3Start + this.zone3Duration; 
    ...
    window.workSliderController = editorialController; 
